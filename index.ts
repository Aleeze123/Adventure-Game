  ...
  if (opponent1.list === "Skeleton") {
    ...
    if (opponent2.fight === "Attack") {
      ...
      if (num > 0) {
        ...
        if (p1.fuel <= 0) {
          console.log(
            chalk.bold.underline.red("You Loose, Better luck next time")
          );
          process.exit();
        }
      }
  ...
  if (opponent1.list === "Assassin") {
    ...
    if (opponent2.fight === "Attack") {
      ...
      if (num <= 0) {
        ...
        if (o1.fuel <= 0) {
          console.log(
            chalk.bold.underline.green("Congratulations! You Win the Game")
          );
          process.exit();
        }
      }
  ...
  if (opponent1.list === "Zombie") {
    ...
    if (opponent2.fight === "Attack") {
      ...
      if (num <= 0) {
        ...
        if (o1.fuel <= 0) {
          console.log(
            chalk.bold.italic.underline.green("Congratulations! You Win the Game")
          );
          process.exit();
        }
      }
